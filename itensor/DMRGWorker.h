...
//
//The DMRGWorker methods actually contain the DMRG code
//
template<class MPSType, class LocalOpT>
Real
DMRGWorker(MPSType& psi, 
           LocalOpT& PH,
           const Sweeps& sweeps, 
           Observer& obs,
           const OptSet& opts);
...
Real 
dmrg(MPSt<Tensor>& psi, const MPOt<Tensor>& H, const Sweeps& sweeps,
     const OptSet& opts)
    {
