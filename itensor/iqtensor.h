...
public:
    ...
    IQTensor(const IQIndex& i1,const IQIndex& i2,const IQIndex& i3,
             const IQIndex& i4) : p(new IQTDat(i1,i2,i3,i4))
	{ }

    IQTensor(const IQIndex& i1,const IQIndex& i2,const IQIndex& i3,
             const IQIndex& i4,const IQIndex& i5) : p(new IQTDat(i1,i2,i3,i4,i5))
	{ }
    ...
    IQTensor(const IQIndexVal& iv1) : p(new IQTDat(iv1.iqind))
	{ 
	operator()(iv1) = 1;
	}
    ...
    explicit IQTensor(std::istream& s) : p(0) 
	{ read(s); }
    ...
    */
    ...
    Real& operator()(const IQIndexVal& iv1, const IQIndexVal& iv2 = IQIndexVal::Null(), 
	    const IQIndexVal& iv3 = IQIndexVal::Null(), const IQIndexVal& iv4 = IQIndexVal::Null(), 
	    const IQIndexVal& iv5 = IQIndexVal::Null(), const IQIndexVal& iv6 = IQIndexVal::Null(),
...
inline bool checkQNs(const ITensor& t) 
    { return true; }
